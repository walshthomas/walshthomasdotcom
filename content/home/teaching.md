...
<ul><li><h5> {{<staticref "uploads/sanctions_current.pdf" "newtab" >}} <i class="fas fa-file-alt"></i> Job Search under the Threat of Unemployment Benefit Sanctions{{< /staticref >}}</h5> {{<staticref "uploads/sanctions_current.pdf" "newtab">}} [Current Draft]{{</staticref>}}
