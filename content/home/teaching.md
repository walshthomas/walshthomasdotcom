...
<ul><li><h5> {{<staticref "uploads/sanctions_current.pdf" "newtab" >}} <i class="fars fa-file-alt"></i> [JMP] Job Search under the Threat of Unemployment Benefit Sanctions{{< /staticref >}}</h5> {{<staticref "uploads/sanctions_current.pdf" "newtab">}} [Current Draft]{{</staticref>}}
